...
import './LabReport.css'; // Import the CSS file for styling
    ...
    <div className="lab-report-page">
      <div className="container mt-5 pt-5">
        <div className="title-section">
          <h1 className="text-center mb-1">Lab Performance Report</h1>
          <div className="title-underline"></div>
          <p className="text-center text-muted subtitle">Analyze lab success and contamination data</p>
        </div>
          ...
          <form onSubmit={(e) => {
            ...
            <div className="report-header">
              ...
              <div className="header-content">
                ...
                <p className="report-subtitle">Select parameters to generate detailed lab report</p>
              </div>
            </div>
